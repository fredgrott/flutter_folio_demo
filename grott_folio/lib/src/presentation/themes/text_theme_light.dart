...
TextTheme textThemeLight() {
  ...
  return TextTheme(
    ...
    displayMedium: TextStyle(
      fontSize:
          fontSize15, // Same as M3, defaults to 60 in Material2018 Typography.

      fontFamily: GoogleFonts.nunito().fontFamily,
    ),
    displaySmall: TextStyle(
      fontSize:
          fontSize14, // Same as M3, defaults to 48 in Material2018 Typography.
    ...
    headlineMedium: TextStyle(
      fontSize:
          fontSize12, // Same as M3, defaults to 34 in Material2018 Typography.
    ...
    labelSmall: TextStyle(
      ...
      letterSpacing:
          letterSpacing2, // Defaults to 1.5 in Material2018 Typography.
