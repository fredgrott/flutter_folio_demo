...
import 'package:folio/src/app_systems/themes/flex_color_scheme_dark.dart';
...
ThemeData flexThemeDark(Color? dynamicColorSourceInput) {
  ...
  inputColor =
      dynamicColorSourceInput != null ? Colors.black : dynamicColorSourceInput;
  

  return flexColorSchemeDark(inputColor!).toTheme;
}
